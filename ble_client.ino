...
void sendSensor(){
  ...
  // start working...
  Serial.println("=================================");
  Serial.println("Sending Rain Intensity...");
  ...
  Serial.println((int)dataSet[idx]); 
  String rain = (String)dataSet[idx];
  idx++;
  if(idx==sizeArr-1){
        idx=0;
  }
  
  pRemoteCharacteristic->writeValue(rain.c_str(), rain.length());
